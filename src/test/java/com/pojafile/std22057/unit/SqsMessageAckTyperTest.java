package com.pojafile.std22057.unit;
...
import com.pojafile.std22057.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.pojafile.std22057.endpoint.event.gen.UuidCreated", payload);
